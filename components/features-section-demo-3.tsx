...
// El IconBrandYoutubeFilled ya no es necesario
...
export default function FeaturesSectionDemo() {
  const features = [
    ...
    {
      title: "Narrador Urbano en Acción",
      description:
        "Mira un demo de cómo nuestra IA convierte un simple paseo en una historia inmersiva. Escucha el alma de la ciudad.",
    ...
    },
    {
      ...
      description:
        "Nuestro motor prioriza negocios locales, arte callejero y lugares únicos para que explores el lado auténtico de la ciudad.",
    ...
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div className="w-full p-5 mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2">
          {/* TODO: Reemplaza "/linear.webp" por una captura de pantalla de la interfaz de rutas de Kamino. */}
          <img
            src="/linear.webp"
            alt="header"
            width={800}
...
export const Globe = ({ className }: { className?: string }) => {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      glowColor: [1, 1, 1],
      markers: [
        // TODO: Cambia estas coordenadas por lugares de tu ciudad.
        // Ejemplo para Tuxtla Gutiérrez:
        { location: [16.7536, -93.129], size: 0.05 },
